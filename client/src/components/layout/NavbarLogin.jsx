        ...
        >
          ...
          {/* Logo */}
            <ul className="hidden gap-6 text-slate-800 md:flex">
              ...
              <li className="cursor-pointer hover:text-slate-600">Courses</li>
              <li className="cursor-pointer hover:text-slate-600">About US</li>
              <li className="cursor-pointer hover:text-slate-600">Job Board</li>
            </ul>
