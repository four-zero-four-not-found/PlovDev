...
// teacher and admin
router.post('/section/:sectionId/lesson',  /* #swagger.tags = ['Lesson'] */  authenticateToken, isTeacherOrAdmin, uploadToVideo.single('video'), createLesson)
router.put('/lesson/:lessonId',  /* #swagger.tags = ['Lesson'] */  authenticateToken, isTeacherOrAdmin, uploadToVideo.single('video'), updateLesson)
